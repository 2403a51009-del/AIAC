...
# ---------- MAIN PROGRAM ----------
if __name__== "_main_":
    print("🖼 AI-Based Image Compression Tool")
    print("==================================")

    # Take input from user
    input_path = input("📂 Enter the full path of your image file: ").strip()
    quality_input = input("🎚 Enter compression quality (1–95, default=40): ").strip()
